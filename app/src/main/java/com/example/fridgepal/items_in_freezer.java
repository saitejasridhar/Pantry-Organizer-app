...
public class items_in_freezer extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                mDatabase= FirebaseDatabase.getInstance().getReference().child(uid).child("Freezer");
                mDatabase.keepSynced(true);

                mBlogList=(RecyclerView)findViewById(R.id.itemsfreezerrecycleview);
        ...
        {
                final MediaPlayer added=MediaPlayer.create(items_in_freezer.this,R.raw.added);
                Toolbar  TbFridge = (Toolbar) findViewById(R.id.toolbar);
                setSupportActionBar(TbFridge);
                getSupportActionBar().setTitle("Freezer");
                super.onStart();
                final MediaPlayer delete=MediaPlayer.create(items_in_freezer.this,R.raw.delete_sound);

                FirebaseRecyclerAdapter<Blog, items_in_freezer.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, items_in_freezer.BlogViewHolder>
                        (Blog.class,R.layout.added_items_row, items_in_freezer.BlogViewHolder.class,mDatabase )
                {
                        ...
                        protected void populateViewHolder(final items_in_freezer.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                                ...
                                blogViewHolder.update.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                                final DialogPlus dialog = DialogPlus.newDialog(items_in_freezer.this)
                                                ...
                                                button.setOnClickListener(new View.OnClickListener() {
                                                        ...
                                                        public void onClick(View view) {
                                                                ...
                                                                Toast.makeText(items_in_freezer.this,"Fridge Updated",Toast.LENGTH_LONG).show();
                                                        }
                                                });
                                        ...
                                        public void onClick(View view) {
                                                ...
                                                button.setOnClickListener(new View.OnClickListener() {
                                                        ...
                                                        public void onClick(View view) {
                                                                ...
                                                                Toast.makeText(items_in_freezer.this,"Item added to List",Toast.LENGTH_LONG).show();
                                                        }
                                                });
