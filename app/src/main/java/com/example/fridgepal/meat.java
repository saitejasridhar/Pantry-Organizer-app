...
public class meat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Meat");
        mDatabase.keepSynced(true);

        mBlogList=(RecyclerView)findViewById(R.id.meatrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(meat.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, meat.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, meat.BlogViewHolder>
                (Blog.class,R.layout.blog_row, meat.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(meat.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(meat.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(meat.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
