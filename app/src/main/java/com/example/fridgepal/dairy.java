...
public class dairy extends AppCompatActivity {
    ...
    protected void onStart()
    {
                ...
                (Blog.class,R.layout.blog_row, dairy.BlogViewHolder.class,mDatabase )
        {
            ...
            @Override
            public void populateViewHolder(dairy.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(dairy.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(dairy.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
