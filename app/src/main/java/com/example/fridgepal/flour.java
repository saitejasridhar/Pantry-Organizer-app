...
public class flour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Flour");
        mDatabase.keepSynced(true);
        items=new ArrayList<>();

        mBlogList=(RecyclerView)findViewById(R.id.flourrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(flour.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, flour.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, flour.BlogViewHolder>
                (Blog.class,R.layout.blog_row, flour.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(flour.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(flour.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(flour.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
