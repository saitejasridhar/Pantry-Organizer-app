...
public class items_in_pantry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child(uid).child("Pantry");
        mDatabase.keepSynced(true);

        mBlogList=(RecyclerView)findViewById(R.id.itemspantryrecycleview);
    ...
    {
        final MediaPlayer added=MediaPlayer.create(items_in_pantry.this,R.raw.added);
        Toolbar  TbFridge = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(TbFridge);
        getSupportActionBar().setTitle("Pantry");
        super.onStart();
        final MediaPlayer delete=MediaPlayer.create(items_in_pantry.this,R.raw.delete_sound);

        FirebaseRecyclerAdapter<Blog, items_in_pantry.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, items_in_pantry.BlogViewHolder>
                (Blog.class,R.layout.added_items_row, items_in_pantry.BlogViewHolder.class,mDatabase )
        {
            @Override
            protected void populateViewHolder(final items_in_pantry.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.update.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(items_in_pantry.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(items_in_pantry.this,"Pantry Updated",Toast.LENGTH_LONG).show();
                            }
                        });
                    ...
                    public void onClick(View view) {
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(items_in_pantry.this,"Item added to List",Toast.LENGTH_LONG).show();
                            }
                        });
