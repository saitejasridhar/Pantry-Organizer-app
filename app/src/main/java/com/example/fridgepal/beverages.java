...
public class beverages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Beverages");
        mDatabase.keepSynced(true);

        mBlogList=(RecyclerView)findViewById(R.id.beveragesrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(beverages.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, beverages.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, beverages.BlogViewHolder>
                (Blog.class,R.layout.blog_row, beverages.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(beverages.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(beverages.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(beverages.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
