...
public class herbs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Herbs");
        mDatabase.keepSynced(true);

        mBlogList=(RecyclerView)findViewById(R.id.herbsrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(herbs.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, herbs.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, herbs.BlogViewHolder>
                (Blog.class,R.layout.blog_row, herbs.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(herbs.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(herbs.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(herbs.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
