...
public class snacks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBlogList=(RecyclerView)findViewById(R.id.snacksrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(snacks.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, snacks.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, snacks.BlogViewHolder>
                (Blog.class,R.layout.blog_row, snacks.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(snacks.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(snacks.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(snacks.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
