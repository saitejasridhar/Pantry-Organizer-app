...
public class oil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Oil");
        mDatabase.keepSynced(true);
        items=new ArrayList<>();

        mBlogList=(RecyclerView)findViewById(R.id.oilrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(oil.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, oil.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, oil.BlogViewHolder>
                (Blog.class,R.layout.blog_row, oil.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(oil.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(oil.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(oil.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
