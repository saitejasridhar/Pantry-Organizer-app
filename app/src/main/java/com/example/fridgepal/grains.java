...
public class grains extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Grains");
        mDatabase.keepSynced(true);
        items=new ArrayList<>();

        mBlogList=(RecyclerView)findViewById(R.id.grainsrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(grains.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, grains.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, grains.BlogViewHolder>
                (Blog.class,R.layout.blog_row, grains.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(grains.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(grains.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(grains.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
