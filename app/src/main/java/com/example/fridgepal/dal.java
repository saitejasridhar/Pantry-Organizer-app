...
public class dal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Dal");
        mDatabase.keepSynced(true);
        items=new ArrayList<>();

        mBlogList=(RecyclerView)findViewById(R.id.dalrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(dal.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, dal.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, dal.BlogViewHolder>
                (Blog.class,R.layout.blog_row, dal.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(dal.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(dal.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(dal.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
