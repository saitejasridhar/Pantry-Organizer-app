...
public class other extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBlogList=(RecyclerView)findViewById(R.id.otherrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(other.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, other.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, other.BlogViewHolder>
                (Blog.class,R.layout.blog_row, other.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(other.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(other.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(other.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
