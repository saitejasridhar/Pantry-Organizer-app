...
public class sauces extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Sauces");
        mDatabase.keepSynced(true);

        mBlogList=(RecyclerView)findViewById(R.id.saucesrecycleview);
    ...
    protected void onStart()
    {
        ...
        super.onStart();
        final MediaPlayer added=MediaPlayer.create(sauces.this,R.raw.added);
        FirebaseRecyclerAdapter<Blog, sauces.BlogViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog, sauces.BlogViewHolder>
                (Blog.class,R.layout.blog_row, sauces.BlogViewHolder.class,mDatabase )
        {

            @Override
            public void populateViewHolder(sauces.BlogViewHolder blogViewHolder, final Blog blog, final int i) {
                ...
                blogViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        final DialogPlus dialog = DialogPlus.newDialog(sauces.this)
                        ...
                        button.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(sauces.this,"Item added",Toast.LENGTH_LONG).show();
                            }
                        });
